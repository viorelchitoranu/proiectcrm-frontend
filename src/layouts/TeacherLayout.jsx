        ...
        <Layout style={{ minHeight: "100vh" }}>
            <Sider breakpoint="lg" collapsedWidth="0">
                <div style={{ padding: 16 }}>
                    <Text strong style={{ color: "white" }}>CRM Teacher</Text>
                    ...
                    items={[
                        {
                            key:   "groups",
                            icon:  <TeamOutlined />,
                            label: <Link to="/teacher/groups">Grupele mele</Link>,
                        },
                        {
                            key:   "requests",
                            icon:  <InboxOutlined />,
                            label: <Link to="/teacher/requests">Cereri părinți</Link>,
                        },
                        // ── NOU: Forum ─────────────────────────────────────────
                        {
                            key:   "board",
                            icon:  <MessageOutlined />,
                            label: <Link to="/teacher/board">Forum</Link>,
                        },
                        {
                            key:   "password",
                            icon:  <LockOutlined />,
                            label: <Link to="/teacher/password">Schimbă parola</Link>,
                        },
                    ]}
                />
            </Sider>
